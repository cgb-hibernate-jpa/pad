...
<dependency>
  ...
  <scope>system</scope>
  <systemPath>${project.basedir}/pad/pad-2.2.0-RELEASE.jar</systemPath>
</dependency>
```
...
> void rollback(ID id, Number revision) 接口是将该实体回滚到当初的快照上，但是不能用于继承在EntityBase的实体上，这是因为EntityBase实体中的createDates属性是不能修改的，所有无法还原。
