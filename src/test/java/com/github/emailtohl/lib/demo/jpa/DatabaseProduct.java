...
public enum DatabaseProduct {
    ...
    ORACLE(
        new DataSourceConfiguration() {
            ...
            public void configure(PoolingDataSource ds, String connectionURL) {
                ...
                ds.getDriverProperties().put("URL",connectionURL != null ?
                		connectionURL : "jdbc:oracle:thin:test/test@localhost:1521:xe"
                );
    ...
    MYSQL(
        ...
        org.hibernate.dialect.MySQL57Dialect.class.getName()
    );
