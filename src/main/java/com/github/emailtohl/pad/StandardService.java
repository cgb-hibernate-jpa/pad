...
public abstract class StandardService<E, ID extends Serializable> {
	...
	/**
	 * 根据ID获取实体
	 * 若未找到可抛出java.util.NoSuchElementException或com.github.emailtohl.pad.exception.NotFoundException
	 * 若有冲突，可抛出com.github.emailtohl.pad.exception.ConflictException
	 * 
	 * @param id 实体的ID
	 * @return 实体对象
	 */
