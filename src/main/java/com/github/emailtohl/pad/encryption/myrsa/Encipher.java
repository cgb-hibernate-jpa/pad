package com.github.emailtohl.pad.encryption.myrsa;
...
import com.github.emailtohl.pad.exception.InvalidDataException;
...
public class Encipher {
	...
	public String encrypt(String plaintext, String publicKey) {
		...
		KeyPairs key = fromJson(json, KeyPairs.class);
	...
	public String decrypt(String ciphertext, String privateKey) {
		...
		Model cm;
		try {
			cm = fromJson(json, Model.class);// 密文数据模型
		} catch (InvalidDataException e) {
			throw new InvalidDataException("The ciphertext is incorrectly formatted", e);
		}
